				                   	   ...
				                   	   <SPAN id=pagelink>
				           				   <DIV style="LINE-HEIGHT: 20px; HEIGHT: 20px; TEXT-ALIGN: right">				           				 				           				   	
								                ...
								                <c:forEach begin="1" end="${pager.pagecount}" var="i">
								                	...
								                	<c:if test="${i!=pager.pageindex}">
								                		<A class="" href="${pageContext.request.contextPath}/good/strict/${i}"><c:out value="${i}"/></A> 
								                	</c:if>								                	
								                </c:forEach>
								                <c:if test="${pager.pageindex!=pager.pagecount}">
								                	[<A class="" href="${pageContext.request.contextPath}/good/strict/${pager.pageindex+1}">后一页</A>]
								                </c:if>						             
