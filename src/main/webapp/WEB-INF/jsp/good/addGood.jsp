		            			...
		            			<td  width="50%">
		            				<table width="100%" bgColor=pink >
		            					...
		            					<tr>
											...
											<td>单价</td>
											<td><input name="good_price" id="price" type="number" min="0" step="0.01" style="width:90%"></td>
										</tr>
		            					<tr><td colspan="4">&nbsp;</td></tr>
		            					<tr>
		            						<td>数量</td>
		            						<td><input name="good_count" id="count" type="number" step="0" min="0" style="width:90%"></td>
		            						<td>金额</td>
