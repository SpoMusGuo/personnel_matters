 ...
 * pageCount		分页查询的最大条数
 * emp_name			存储该条件的值
 * semp_name		S+变量名，存储该条件的条件类型（=，!= , > ,>= ,<, <=, 介于, 形如, 非空, 为空）
 ...
 *
 */
public class AgreementsSelectRequirement2 {
	...
	private String emp_department = "null";
	...
	private String signdata1;
	private Double probation_period;
	private String sprobation_period;
	private Double probation_period1;
	private String probation_begindata;
	private String sprobation_begindata;
	private String probation_begindata1;
	private BigDecimal probation_sal;
	private String sprobation_sal;
	private BigDecimal probation_sal1;
	private String probation_overdata;
	private String sprobation_overdata;
	private String probation_overdata1;
	 ...
	 */
	public void setSigndata1(String signdata1) {
	 ...
	 */
	public String getSprobation_period() {
		return sprobation_period;
	}
	/**
	 * @param sprobation_period 要设置的 sprobation_period
	 */
	public void setSprobation_period(String sprobation_period) {
	 ...
	 */
	public String getSprobation_begindata() {
		return sprobation_begindata;
	}
	/**
	 * @param sprobation_begindata 要设置的 sprobation_begindata
	 */
	public void setSprobation_begindata(String sprobation_begindata) {
		this.sprobation_begindata = sprobation_begindata;
	}
	/**
	 * @return probation_begindata1
	 */
	public String getProbation_begindata1() {
		return probation_begindata1;
	}
	/**
	 * @param probation_begindata1 要设置的 probation_begindata1
	 */
	public void setProbation_begindata1(String probation_begindata1) {
	 ...
	 */
	public String getSprobation_sal() {
		return sprobation_sal;
	}
	/**
	 * @param sprobation_sal 要设置的 sprobation_sal
	 */
	public void setSprobation_sal(String sprobation_sal) {
	 ...
	 */
	public String getSprobation_overdata() {
		return sprobation_overdata;
	}
	/**
	 * @param sprobation_overdata 要设置的 sprobation_overdata
	 */
	public void setSprobation_overdata(String sprobation_overdata) {
		this.sprobation_overdata = sprobation_overdata;
	}
	/**
	 * @return probation_overdata1
	 */
	public String getProbation_overdata1() {
		return probation_overdata1;
	}
	/**
	 * @param probation_overdata1 要设置的 probation_overdata1
	 */
	public void setProbation_overdata1(String probation_overdata1) {
	 ...
	 * @return sregularsal
	 */
	public String getSregularsal() {
		return sregularsal;
	}
	/**
	 * @param sregularsal 要设置的 sregularsal
	 */
	public void setSregularsal(String sregularsal) {
